...
<html>
<head>
	<title>SPE - Seleção de Atributos</title>
	...
	<div class="row">
		...
		<div class="d-flex flex-wrap campo-inicial col-md-6 ui-helper-reset ui-helper-clearfix" id="campoInicial">	
					...
					<div class="caixa_atributo drag">
	 					<label for="nomeAtributo"> ID Docente </label>
						<input type="hidden" name="checked[]" value="docente.id">
						<input class="inputAtributo" style="display: none;" name="input[0][]" id="docente_id" type="number" step="any" placeholder="ID do docente">
					</div>

					<div class="caixa_atributo drag">
	 					<label for="nomeAtributo">Efetivo</label>
						<input type="hidden" name="checked[]" value="docente.efetivo">
		...
		<div class="col-md-6 campo-drop drop d-flex flex-wrap-reverse ui-widget-content ui-state-default" id="drop" name="campo-drop">
			<form action="/sape/Aluno_docente/chamarWeka" method="POST">
